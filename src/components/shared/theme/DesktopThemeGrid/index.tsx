...
//             </div>
//           </div>
//           <h1 className="text-4xl font-bold mb-3 transition-colors duration-300 text-text">
//             Choose Your Reading Theme
//           </h1>
//           <p className="text-lg max-w-2xl mx-auto transition-colors duration-300 text-text-muted">
...
import { DesktopThemeGridProps } from "@/types/theme";
import ThemeCard from "./DesktopThemeCard";
